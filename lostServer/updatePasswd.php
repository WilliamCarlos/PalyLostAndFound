...
if(!is_array($row)) {
    header("Location: http://lostandfound.paly.net/lost/emailVerifFailed.php");
    return;                    
}
$userId = $row['name'];
    ...
    <form name="frmUser" method="post" action="update_passwd.php">
      <table border="0" cellpadding="10" cellspacing="1" width="500" align="center">
        <tr class="tableheader">
          <td align="center" colspan="2"><h4>Update Password</h4></td>
        </tr>
        <tr class="tablerow">
        ...
        <tr class="tablerow">
          <td align="right">Enter <b>New</b> Password</td>
